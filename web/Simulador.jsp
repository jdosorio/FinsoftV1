    ...
    <div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="txSimuTele" id="txSimuTele" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                    </div><!-- /.input group -->
                  </div><!-- /.form-group -->
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="ejemplo">
                  </div><!-- /.form-group -->
                  <div class="form-group">
                    <label>eMail</label>
                    <div class="input-group">
          ...
          <div class="box box-success">
                ...
                <div class="box-footer">
                  <div class="input-group">
                    <input class="form-control" placeholder="Observaciones...">
